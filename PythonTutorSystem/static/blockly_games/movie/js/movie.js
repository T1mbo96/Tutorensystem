...
Movie.init = function() {
  ...
  BlocklyGames.workspace.getAudioManager().load(
      ['/static/blockly_games/movie/win.mp3', '/static/blockly_games/movie/win.ogg'], 'win');
...
Movie.submitToGallery = function() {
  ...
  var thumbData = thumbnail.toDataURL('/static/blockly_games/image/png');
  document.getElementById('/static/blockly_games/galleryThumb').value = thumbData;
