...
Pond.Duck.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.Duck.soy.messages(null, null, opt_ijData) + '<h1>' + BlocklyGames.soy.titleSpan({appName: 'Pond'}, null, opt_ijData) + '</h1>' + Pond.soy.visualization(null, null, opt_ijData) + '<div id="tabarea" style="visibility: hidden"><div id="tabbar" class="goog-tab-bar goog-tab-bar-top"><div class="goog-tab goog-tab-selected">Blocks</div></div><div class="goog-tab-bar-clear"></div><div id="blockly"></div><div id="editor" class="not_editable"></div></div><script>$(document).ready(function() {alert(\'YES\'); var areas = document.getElementsByClass(\'ace_text-input\'); for element in areas {areas.setAttribute(\'readonly\', \'readonly\');}});<\/script>' + Pond.Duck.soy.toolbox(null, null, opt_ijData) + Pond.Duck.soy.playerRabbit(null, null, opt_ijData) + Pond.Duck.soy.playerCounter(null, null, opt_ijData) + Pond.Duck.soy.playerRook(null, null, opt_ijData) + Pond.Duck.soy.playerSniper(null, null, opt_ijData) + BlocklyGames.soy.dialog(null, null, opt_ijData);
};
if (goog.DEBUG) {
