...
function reset_highlighted_sections(lesson_id) {
    ...
    if (lesson_id === 'python') {
        sections = ['variables_id', 'datatypes_id', 'strings_id', 'operators_id', 'print_id', 'input_id', 'conditional_statements_id', 'while_loop_id', 'for_loop_id', 'lists_id', 'tuple_id', 'set_id', 'dictionary_id', 'functions_id', 'recursion_id', 'namespace_id', 'oop_id', 'classes_id', 'heredity_id'];
