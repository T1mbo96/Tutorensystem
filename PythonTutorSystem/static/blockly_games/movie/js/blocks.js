...
Blockly.Python['movie_circle'] = function(block) {
  // Generate JavaScript for drawing a circle.
...
Blockly.Python['movie_rect'] = function(block) {
  // Generate JavaScript for drawing a rectangle.
  var x = Blockly.Python.valueToCode(block, 'X',
      Blockly.Python.ORDER_NONE) || '0';
  var y = Blockly.Python.valueToCode(block, 'Y',
  ...
  var width = Blockly.Python.valueToCode(block, 'WIDTH',
      Blockly.Python.ORDER_NONE) || '0';
  var height = Blockly.Python.valueToCode(block, 'HEIGHT',
      Blockly.Python.ORDER_NONE) || '0';
  return 'rect(' + x + ', ' + y + ', ' + width + ', ' + height + ')\n';
};
...
Blockly.Python['movie_line'] = function(block) {
  // Generate JavaScript for drawing a line.
  var x1 = Blockly.Python.valueToCode(block, 'X1',
      Blockly.Python.ORDER_NONE) || '0';
  var y1 = Blockly.Python.valueToCode(block, 'Y1',
      Blockly.Python.ORDER_NONE) || '0';
  var x2 = Blockly.Python.valueToCode(block, 'X2',
      Blockly.Python.ORDER_NONE) || '0';
  var y2 = Blockly.Python.valueToCode(block, 'Y2',
      Blockly.Python.ORDER_NONE) || '0';
  var width = Blockly.Python.valueToCode(block, 'WIDTH',
      Blockly.Python.ORDER_NONE) || '0';
  return 'line(' + x1 + ', ' + y1 + ', ' + x2 + ', ' + y2 + ', ' +
...
Blockly.Python['movie_time'] = function(block) {
  // Generate JavaScript for getting the current time value.
  var code = 'time()';
...
Blockly.Python['movie_colour'] = function(block) {
  // Generate JavaScript for setting the colour.
