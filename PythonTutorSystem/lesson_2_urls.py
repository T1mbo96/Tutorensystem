...
urlpatterns = [
    ...
    path('Variablen/Aufgabe/', views.lesson_2_exercises_variables, name='lesson_2_exercises_variables'),
    ...
    path('while_Schleife/Aufgabe/', views.lesson_2_exercises_while_loop, name='lesson_2_exercises_while_loop'),
    path('for_Schleife/', views.lesson_2_for_loop, name='lesson_2_for_loop'),
    path('Listen/', views.lesson_2_list, name='lesson_2_list'),
    path('Listen/Aufgabe/', views.lesson_2_exercises_list, name='lesson_2_exercises_list'),
