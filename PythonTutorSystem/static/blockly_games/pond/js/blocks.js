...
Blockly.Python['pond_scan'] = function(block) {
  // Generate JavaScript for scanning the pond.
  var value_degree = Blockly.Python.valueToCode(block, 'DEGREE',
      Blockly.JavaScript.ORDER_NONE) || 0;
  var code = 'scan(' + value_degree + ')';
  return [code, Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['pond_cannon'] = function(block) {
  // Generate JavaScript for shooting.
  var value_degree = Blockly.Python.valueToCode(block, 'DEGREE',
      Blockly.JavaScript.ORDER_COMMA) || 0;
  var value_range = Blockly.Python.valueToCode(block, 'RANGE',
      Blockly.JavaScript.ORDER_COMMA) || 0;
  return 'cannon(' + value_degree + ', ' + value_range + ')\n';
};
...
Blockly.Python['pond_swim'] = function(block) {
  // Generate JavaScript for swimming.
  var value_degree = Blockly.Python.valueToCode(block, 'DEGREE',
      Blockly.JavaScript.ORDER_NONE) || 0;
  return 'swim(' + value_degree + ')\n';
...
Blockly.Python['pond_stop'] = function(block) {
  // Generate JavaScript for stopping.
  return 'stop()\n';
};
...
Blockly.Python['pond_health'] = function(block) {
  // Generate JavaScript for avatar health.
  return ['health()', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['pond_speed'] = function(block) {
  // Generate JavaScript for avatar speed.
  return ['speed()', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['pond_getX'] = function(block) {
  // Generate JavaScript for X coordinate.
  return ['getX()', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['pond_getY'] = function(block) {
  // Generate JavaScript for Y coordinate.
  return ['getY()', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
...
Blockly.Python['pond_math_single'] = function(block) {
  // Advanced math operators with single operand.
  var operator = block.getFieldValue('OP');
  var code;
  var arg = Blockly.Python.valueToCode(block, 'NUM',
          Blockly.JavaScript.ORDER_NONE) || '0';
  // First, handle cases which generate values that don't need parentheses
  // wrapping the code.
  switch (operator) {
    ...
    case 'ROOT':
      ...
      break;
    case 'SIN':
      code = 'math.degrees(math.sin(' + arg + '))';
      break;
    case 'COS':
      code = 'math.degrees(math.cos(' + arg + '))';
      break;
    case 'TAN':
      code = 'math.degrees(math.tan(' + arg + '))';
      break;
    case 'ASIN':
...
Blockly.Python['pond_math_number'] = Blockly.Python['math_number'];
...
Blockly.Python['pond_controls_if'] = Blockly.Python['controls_if'];
...
Blockly.Python['pond_loops_while'] = Blockly.Python['controls_whileUntil'];
...
Blockly.Python['pond_math_arithmetic'] = Blockly.Python['math_arithmetic'];
...
Blockly.Python['pond_math_change'] = Blockly.Python['math_change'];
